<div class="py-12">
    <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
        ...
        <div class="mb-6">
            ...
            <p class="mt-1 text-sm text-gray-600">View all wallet transactions across all users</p>
        </div>
                ...
                <div class="p-6">
                    <div class="flex items-center">
                        ...
                        <div class="ml-3">
                            ...
                            <p class="text-2xl font-bold text-green-600">₹{{ number_format($this->stats['total_credits'], 2) }}</p>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="p-6">
                    <div class="flex items-center">
                        ...
                        <div class="ml-3">
                            ...
                            <p class="text-2xl font-bold text-red-600">₹{{ number_format($this->stats['total_debits'], 2) }}</p>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="p-6">
                    <div class="flex items-center">
                        ...
                        <div class="ml-3">
                            ...
                            <p class="text-2xl font-bold text-gray-900">{{ number_format($this->stats['transaction_count']) }}</p>
                        </div>
                    </div>
                </div>
            </div>
